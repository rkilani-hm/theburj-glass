    ...
    <footer style={{ background: "var(--surface)", borderTop: "1px solid var(--border)" }}>
      <div className="container-fluid" style={{ paddingTop: "clamp(4rem,8vw,8rem)", paddingBottom: "clamp(3rem,6vw,6rem)" }}>
        <div className="grid lg:grid-cols-12 gap-12">
              ...
              {CONTACTS.map(c => (
                <div key={c.valKey}>
                  <EditableText cms={c.labelKey} tag="span" oneLine style={{
                    ...
                    textTransform: "uppercase", color: "var(--ink-faint)", display: "block", marginBottom: 2,
                  }} />
                  <EditableText cms={c.valKey} tag="span" oneLine style={{
                    fontFamily: "var(--font-sans)", fontSize: "13px", fontWeight: 300, color: "var(--ink-mid)",
                  }} />
                </div>
              ))}
            </div>
          ...
          {/* Nav columns — not editable (structural) */}
