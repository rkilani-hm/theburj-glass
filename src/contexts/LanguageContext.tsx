...
const translations: Record<string, Record<Language, string>> = {
  ...
  // Hero
  "hero.headline": { en: "Al Hamra Business Tower", ar: "برج الحمراء للأعمال" },
  "hero.headline2": { en: "Kuwait's Most Iconic Business Address", ar: "العنوان التجاري الأكثر أيقونية في الكويت" },
  "hero.subline": { en: "A sculptural landmark designed for performance, prestige, and long-term corporate value.", ar: "معلم نحتي صُمم للأداء والهيبة والقيمة المؤسسية طويلة المدى." },
  "hero.subline2": { en: "A sculptural landmark designed for performance, prestige, and long-term corporate value.", ar: "معلم نحتي صُمم للأداء والهيبة والقيمة المؤسسية طويلة المدى." },
  ...
  // Stats
  "stats.height": { en: "Landmark Height", ar: "ارتفاع المعلم" },
  "stats.height.desc": { en: "Kuwait's tallest structure, commanding the city skyline", ar: "أطول هيكل في الكويت، يهيمن على أفق المدينة" },
  "stats.floors": { en: "Floors of Premium Office Space", ar: "طابقاً من المساحات المكتبية المتميزة" },
  "stats.floors.desc": { en: "Designed for executive performance and operational continuity", ar: "مصممة للأداء التنفيذي والاستمرارية التشغيلية" },
  "stats.sqm": { en: "Column-Free Lobby", ar: "ردهة بدون أعمدة" },
  "stats.sqm.desc": { en: "A grand arrival experience reinforcing corporate stature", ar: "تجربة وصول فخمة تعزز المكانة المؤسسية" },
  ...
  // Home Page
  "home.about": { en: "Strategic Position", ar: "المكانة الاستراتيجية" },
  "home.intro.title": { en: "More Than a Tower. A Strategic Business Platform.", ar: "أكثر من برج. منصة أعمال استراتيجية." },
  "home.intro.p1": { en: "In today's competitive commercial landscape, your address reflects your ambition. Al Hamra Business Tower is not simply a vertical structure — it is a purpose-built business environment designed to support executive performance, operational continuity, and long-term corporate presence.", ar: "في المشهد التجاري التنافسي اليوم، يعكس عنوانك طموحك. برج الحمراء للأعمال ليس مجرد هيكل عمودي — إنه بيئة أعمال مصممة لدعم الأداء التنفيذي والاستمرارية التشغيلية والحضور المؤسسي طويل المدى." },
  "home.intro.p2": { en: "From climate-responsive architecture to integrated services and seamless city connectivity, every element reinforces business performance and professional stature.", ar: "من العمارة المستجيبة للمناخ إلى الخدمات المتكاملة والاتصال السلس بالمدينة، كل عنصر يعزز الأداء التجاري والمكانة المهنية." },
  "home.explore.tower": { en: "Explore the Tower", ar: "استكشف البرج" },
  "home.manifesto.label": { en: "Architecture", ar: "العمارة" },
  "home.manifesto.title": { en: "Architecture That Performs", ar: "عمارة تؤدي" },
  "home.manifesto.p1": { en: "Rising approximately 412 metres above Kuwait City, the tower's sculpted form is shaped by environmental intelligence. A carved southern façade reduces solar exposure, while expansive glazing captures panoramic views of the city and Gulf.", ar: "يرتفع البرج حوالي ٤١٢ متراً فوق مدينة الكويت، وشكله النحتي مصاغ بذكاء بيئي. الواجهة الجنوبية المنحوتة تقلل التعرض للشمس، بينما الزجاج الواسع يلتقط إطلالات بانورامية على المدينة والخليج." },
  "home.manifesto.p2": { en: "The result is a balance between presence and performance — architectural clarity aligned with operational efficiency.", ar: "النتيجة توازن بين الحضور والأداء — وضوح معماري يتوافق مع الكفاءة التشغيلية." },
  ...
  "home.cta.label": { en: "Leasing", ar: "التأجير" },
  "home.cta.title": { en: "Secure Your Position at Kuwait's Premier Business Address", ar: "احجز مكانتك في العنوان التجاري الأول في الكويت" },
  "home.cta.desc": { en: "Whether you require a full-floor headquarters, a customized configuration, or a long-term corporate base, our leasing team will guide you through available opportunities aligned with your strategic goals.", ar: "سواء كنت بحاجة إلى مقر طابق كامل أو تكوين مخصص أو قاعدة مؤسسية طويلة المدى، سيرشدك فريق التأجير لدينا إلى الفرص المتاحة المتوافقة مع أهدافك الاستراتيجية." },
  "home.cta.leasing": { en: "Request Availability", ar: "طلب التوفر" },
  "home.cta.contact": { en: "Download Brochure", ar: "تحميل الكتيب" },

  // Home Page Links
  "home.links.label": { en: "Explore", ar: "استكشف" },
  "home.links.title": { en: "Designed for Corporate Excellence", ar: "مصمم للتميز المؤسسي" },
  "home.links.subtitle": { en: "Every dimension of Al Hamra supports confident business operations.", ar: "كل بُعد في الحمراء يدعم عمليات أعمال واثقة." },
  "home.link.tower.title": { en: "Recognition", ar: "التقدير" },
  "home.link.tower.subtitle": { en: "Global Acknowledgement", ar: "اعتراف عالمي" },
  "home.link.tower.desc": { en: "Al Hamra Business Tower has received international recognition for architectural excellence and long-term presence on the skyline. It stands not only as Kuwait's tallest building, but as a symbol of ambition and performance.", ar: "نال برج الحمراء للأعمال تقديراً دولياً للتميز المعماري والحضور طويل المدى على الأفق. لا يقف كأطول مبنى في الكويت فحسب، بل كرمز للطموح والأداء." },
  "home.link.tower.cta": { en: "Explore the Tower", ar: "استكشف البرج" },
  "home.link.business.title": { en: "Business Value", ar: "القيمة التجارية" },
  "home.link.business.subtitle": { en: "Corporate Infrastructure", ar: "البنية التحتية المؤسسية" },
  "home.link.business.desc": { en: "Al Hamra Business Tower delivers flexible floor plates, efficient vertical circulation, professional building systems, and integration with daily services — forming a cohesive ecosystem that supports confident business operations.", ar: "يوفر برج الحمراء للأعمال طوابق مرنة، وتنقلاً عمودياً فعالاً، وأنظمة مباني احترافية، وتكاملاً مع الخدمات اليومية — مشكلاً منظومة متماسكة تدعم عمليات أعمال واثقة." },
  "home.link.business.cta": { en: "View Office Spaces", ar: "عرض المساحات المكتبية" },
  "home.link.experience.title": { en: "Experience", ar: "التجربة" },
  "home.link.experience.subtitle": { en: "Operational Confidence", ar: "الثقة التشغيلية" },
  "home.link.experience.desc": { en: "Professional property management, secure access systems, ICT infrastructure, concierge services, and structured parking solutions create a work environment built for uninterrupted performance.", ar: "إدارة عقارية احترافية، وأنظمة وصول آمنة، وبنية تحتية للاتصالات، وخدمات كونسيرج، وحلول مواقف منظمة تخلق بيئة عمل مبنية للأداء المتواصل." },
  "home.link.experience.cta": { en: "Discover the Experience", ar: "اكتشف التجربة" },
  "home.link.leasing.title": { en: "Location", ar: "الموقع" },
  "home.link.leasing.subtitle": { en: "Strategic Advantage", ar: "ميزة استراتيجية" },
  "home.link.leasing.desc": { en: "Located in Kuwait City's commercial district, the tower offers direct proximity to financial institutions, government entities, retail amenities, and major transport routes — combining prestige with practicality.", ar: "يقع في المنطقة التجارية بمدينة الكويت، ويوفر البرج قرباً مباشراً من المؤسسات المالية والجهات الحكومية ومرافق التجزئة وطرق النقل الرئيسية — يجمع بين الهيبة والعملية." },
  "home.link.leasing.cta": { en: "View Location", ar: "عرض الموقع" },
