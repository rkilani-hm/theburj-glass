          ...
          <div className="container-fluid">
            ...
            >
              <div className="space-y-8">
                <p className="text-sm uppercase tracking-widest text-muted-foreground">By Skidmore, Owings & Merrill</p>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    className="p-8  bg-background/80 hover:border-border transition-colors duration-300"
                  >
        ...
        <section className="py-24 px-6 lg:px-12 bg-muted/30">
          <div className="container-fluid">
            <motion.div
              ...
              className="space-y-6"
            >
              <p className="text-sm uppercase tracking-widest text-muted-foreground">SOM Structural Engineering</p>
              <h2 className="text-3xl lg:text-4xl font-light tracking-wide">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {specs.map((spec, index) => (
                  <motion.div
                    ...
                    className="p-6  bg-background/80 text-center hover:border-border transition-colors duration-300"
                  >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {analysisModels.map((model, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="p-6  bg-background/80 hover:border-border transition-colors duration-300"
                  >
                    <div className="w-12 h-12 bg-foreground/10 border border-border flex items-center justify-center mb-4 rounded-xl">
                      <span className="text-foreground font-light text-lg">{index + 1}</span>
                    </div>
