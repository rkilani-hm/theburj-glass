        ...
        <section className="relative min-h-[80vh] overflow-hidden bg-gradient-to-b from-emerald-50/50 to-background">
          ...
          <div className="container-fluid">
            <motion.div
              ...
              className="max-w-3xl"
            >
              <div className="inline-flex items-center gap-2 text-stone mb-6">
                <Leaf className="w-5 h-5" />
              <span className="text-sm uppercase tracking-widest text-stone">Environmental Strategy</span>
              </div>
          ...
          <div className="container-fluid">
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-sm uppercase tracking-widest text-stone">Form Follows Climate</p>
        ...
        <section className="py-24 px-6 lg:px-12 bg-gradient-to-b from-background to-muted/30">
          <div className="container-fluid">
            <div className="text-center mb-16">
              ...
              >
                <p className="text-sm uppercase tracking-widest text-stone mb-4">By The Numbers</p>
        ...
        <section className="py-32 px-6 lg:px-12">
          <div className="container-fluid">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <Leaf className="w-12 h-12 text-stone mx-auto mb-8" strokeWidth={1} />
